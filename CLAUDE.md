...
- 명령: 위 Build & Run. 전체 테스트는 H2라 로컬 DB 불필요, 2026-09-22 기준 124 클래스(57 파일) 450건. 로컬 실행만 MariaDB `song` 필요.
