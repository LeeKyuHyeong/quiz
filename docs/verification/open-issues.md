...
| O-013 | OPEN | Auth | 로그인 주체 슬림화의 로그인 상태 화면 확인 (솔로 설정 닉네임 자동 입력 / 게시판 글쓰기·댓글 / 통계 내 기록 / 관리자 곡 신고 처리) | 에이전트는 로그인 비밀번호 입력 불가 | records/2026-09-19_slim-login-principal §6 | 2026-09-19 | |
